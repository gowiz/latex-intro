...
\begin{frame}[fragile]
  ...
  \item[control sequences]\mbox\
    \begin{description}
    \item[control words] Bv. \verb#\bf# om de text in het vet te plaatsen, of \verb#\frac{a}{b}# om een breuk $\frac{a}{b}$ te maken.
    \item[control symbols] Een backslash gevolgd door een enkel symbool, bv. \verb#\$# om \$ te typesetten.
    \end{description}
  \end{description}
\end{frame}
