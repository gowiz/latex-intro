...
\begin{frame}[fragile]
  \frametitle{Commands}
  \begin{description}
  \item[typeset me] Bv. de letter \texttt{a}
  \item[control sequences]\mbox\
    \begin{description}
    \item[control words] Bv. \lstinline#\bf# om de text in het vet te plaatsen, of \lstinline#\frac{a}{b}# om een breuk $\frac{a}{b}$ te maken. Kunnen parameters hebben.
    \item[control symbols] Een backslash gevolgd door een enkel symbool, bv. \lstinline#\$# om \$ te typesetten.
    \end{description}
  \end{description}
\end{frame}
...
\begin{frame}[fragile]
  ...
  Spatie
  \begin{itemize}
  \item Eén of meerdere spaties tellen als één spatie.
